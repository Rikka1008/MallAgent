...
const formatApplyType = (type: OmsOrderReturnApply['applyType']) => {
  return { refund: '退款', return: '退货', exchange: '换货' }[type] || '退货'
}
    ...
    <el-card shadow="never" class="standard-margin">
      ...
      <div class="form-container-border">
        ...
        <el-row>
          ...
          <el-col class="form-border font-small" :span="18">{{ formatApplyType(orderReturnApply.applyType) }}</el-col>
        </el-row>
        <el-row>
      ...
      <div class="form-container-border">
        ...
        <div v-show="orderReturnApply.status !== 3 && orderReturnApply.applyType !== 'refund'">
          <el-row>
      ...
      <div style="margin-top:15px;text-align: center" v-show="orderReturnApply.status === 0">
        <el-button type="primary" size="small" @click="handleUpdateStatus(1)">确认受理</el-button>
        <el-button type="danger" size="small" @click="handleUpdateStatus(3)">拒绝申请</el-button>
      </div>
      <div style="margin-top:15px;text-align: center" v-show="orderReturnApply.status === 1">
        <el-button type="primary" size="small" @click="handleUpdateStatus(2)">确认完成</el-button>
      </div>
    </el-card>
  </div>
</template>
